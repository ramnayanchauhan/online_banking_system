...
$acc=mysqli_query($db,"SELECT * FROM accounts WHERE customerid='".$_SESSION['customerid']."'");
?>
<html>
<head>
     	...
     	<h2>Make Payment</h2>
        	    ...
        	    <tr>
        	      ...
        	      <td><label>
        	        ...
        	        <?php   $result=mysqli_query($db,"SELECT * FROM registered_payee");
					  while($arrvar=mysqli_fetch_array($result))
			  {
				echo "<option value='".$arrvar['slno']."'>".$arrvar['payeename']."</option>";
			  }  
                          $result1= mysqli_query($db,"SELECT * FROM customers");
