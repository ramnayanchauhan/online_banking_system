...
{
	$mailres=mysqli_query($db,"SELECT * FROM mail where mailid='$_REQUEST[mailid]'");
        $mailarr=  mysqli_fetch_array($mailres);
        if (!($mailarr['senderid']=='admin'))
        {
            $mailresult=  mysqli_query($db,"SELECT * FROM customers WHERE customerid='".$mailarr['senderid']."'");
        ...
        {
            $mailresult=  mysqli_query($db,"SELECT * FROM customers WHERE customerid='".$mailarr['reciverid']."'");
            $mailresarr = mysqli_fetch_array($mailresult);
