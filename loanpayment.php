...
{
	mysqli_query("UPDATE loanpayment SET payment_id='$_POST[payment_id]',	customer_id='$_POST[customer_id]',	loan_amt='$_POST[loan_amt]',	interest='$_POST[interest]',	total_amt='$_POST[total_amt]',	paid='$_POST[paid]',	balance='$_POST[balance]',	paid_date='$_POST[paydate]' WHERE payment_id='$_POST[payment_id]'");
    ...
    <div id="sidecon">
       <h2>View Loan Payment</h2>
        	...
        	<form id="form1" name="form1" method="post" action="">
              ...
              <?php     $result = mysqli_query("select * from loanpayment where customerid='$_SESSION[customerid]'");
