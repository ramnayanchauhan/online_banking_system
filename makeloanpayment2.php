...
$resul=mysqli_query($db,"SELECT * FROM customers WHERE customerid='$custid'");
			...
			{ ?>
                                ...
                                <table width="580" height="220" border="1">
                                    <tr>
                                        ...
                                        <td width="361">
                                        <?php	
				  	                    $result3=mysqli_query($db,"SELECT * FROM loan WHERE loanid='$_POST[payto]'");
                                        $arrpayment3=mysqli_fetch_array($result3);
                                        $qq="SELECT * FROM loanpayment WHERE loanid='$_POST[payto]'";
                                        $x=mysqli_query($db,$qq) or die(mysqli_error());
                                        $aamt=0;
