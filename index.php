...
<div id="toptabmenu">
    <ul id="nav">
        ...
        <li><a href="">Downloads</a>
            <ul>
                <li><a href="downloads/bank_open_acc.pdf">New Account form</a></li>
    	...
    	<div id="slider" style="float:left">
            ...
            <img src="images/img_5.png"/>
             ...
             <div class="ex"><div class="heading">ANNOUNCEMENTS</div><br/><div class="low">
                         ...
                         <li class="one">Board meeting on 11/04/2018<br/><br/></li>
    ...
    <hr/><br/>
         <div class="home">
             <div class="begin"> <h2><a href="customer.php">Register For NetBanking Now!!</a></h2> <br/>Now monitor, transact and control your bank account online through our net banking service. 
...
<div class="begin">Register now for RRACH Bank's internet banking service to get started and avail for you multiple utility services, all in a matter of a click. Getting started with our internet banking is real easy. 
All you need to do is follow a few simple steps and you are good to go. <a href="customer.php">Click here</a> for our registration process
