...
{ 					
	mysqli_query("UPDATE registered_payee SET payeename='$_POST[p_name3]',accountnumber='$_POST[ac_no3]',accounttype='$_POST[ac_type3]',bankname='$_POST[bank_name3]',ifsccode='$_POST[code3]' WHERE slno='$_POST[pid3]'");
...
{
	mysqli_query("$db,DELETE FROM registered_payee WHERE sl_no='$_POST[pid3]'");
	$updt= mysqli_affected_rows();
	if($updt==1)
	{
...
$result = mysqli_query($db,"select * from registered_payee WHERE customerid='$_SESSION[customerid]'");

if(isset($_GET[payeeid]))        	
{
$result1 = mysqli_query($db,"select * from registered_payee WHERE sl_no='$_GET[payeeid]'");
